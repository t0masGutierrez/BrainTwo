...
$$
\lim _ { x \to n } f ( x ) \times g ( x ) = L \times K
$$
...
$$
\begin{aligned}
\lim _ { x \to n } f ( x ) \div g ( x ) = L \div K \\
K \ne 0
\end{aligned}
$$
...
$$
\begin{aligned}
\lim _ { x \to n } ( f \circ g ) ( x ) = f [ \lim _ { x \to n } g ( x ) ] \\
g ( x ) = L \\
L \in f
\end{aligned}
$$
...
- $\lim _ { x \to n } g ( x ) = \lim _ { x \to n } h ( x ) = L$
...
- if odd exponent then negative factor equal negative product
...
- direct substitution of infinity into quotient
- if inequality not equal then limit does not exist
...
\forall x \in [ a , b ] \lim _ { x \to n } f ( x ) = f ( n )
\end{aligned}
$$
...
$$
\begin{aligned}
\lim _ { x \to n } \frac { f ( x ) } { g ( x ) } = \lim _ { x \to n } \frac { f ' ( x ) } { g ' ( x ) }
\end{aligned}
$$
...
- do not apply the quotient rule of differentiation
- compute limit of derivative ratio

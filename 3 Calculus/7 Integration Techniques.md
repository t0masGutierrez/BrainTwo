...
- if $n\ge2$ then tabular integration
- alternate sign
- differentiate *u*
- integrate *dv*
...
- for every $(ax^{2}+bx+c)^{n}$ the partial fraction decomposition must include the sum of the following *n* fractions $\frac{B_{n}x+C_{n}}{(ax^{2}+bx+c)^{n}}$

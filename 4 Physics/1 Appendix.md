...
1 \text { light-year } & = 9.461 \times 10 ^ { 15 } \text { m }
\end{aligned}
$$
...
1 \text { furlong/fortnight } & = 1.662 \times 10 ^ { - 4 } \text { m/s }
\end{aligned}
$$
...
$$
\begin{aligned}
1 \text { kg } & \leftrightarrow 8.988 \times 10 ^ { 16 } \text { J } \\
1 \text { u } & \leftrightarrow 931.5 \text { MeV } \\
1 \text { eV } & \leftrightarrow 1.074 \times 10 ^ { - 9 } \text { u }
\end{aligned}
$$

...
\text{Gas constant}&R=N_{A}k_{B}&8.314462618\ldots\frac{\text{J}}{\text{mol}\cdot\text{K}}\\
...
\text{Electric constant}&\epsilon_{0}=\frac{1}{\mu_{0}c^{2}}&8.854187817\times10^{-12}\frac{\text{C}^{2}}{\text{N}\cdot\text{m}^{2}}\\

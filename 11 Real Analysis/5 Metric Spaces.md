...
\exists x _ { 0 } \in \mathbb R , \exists r > 0 : S \subset B _ { r } ( x _ { 0 } ) \subset \mathbb R \implies \exists \sup S \in \overline S \\
( S \subset K ) \land ( K ' \subset K \subset X ) \implies \overline S \subset \overline K = K \\
\overline { \bigcup _ { i \in I } A _ { i } } = \bigcup _ { i \in I } \overline A _ { i } \\
\end{aligned}
$$
